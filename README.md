...
Optional weapon stat row: **Hit Power** (weapon base power as %, good for comparing guns) or **Damage Per Ammo** — the same numbers as the first (no-armor) column of the damage table, one per ammo in the table's order.
